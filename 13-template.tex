...
We used unit testing on especially on the model to prevent regressions, and we tested only observable behaviour.
Our unit test suite uses Junit.
We decided not to use testing on UI components, since our UI is pretty basic, and we thought other areas of the 

...
Problem: The logger hasthe to be extensible, and needs to support loggers wrapping each other.
for example we might want to log timestamps first, and add some verbosity later, or vice versa.
We also want to be able to do this dynamically. We also want to favour composition over inheritance.
...
active, they bring up or down the environment's temperature by 1 degree celsius multiplied by their intensity.
...
flexibility in our implementation, and still limit our inheritance to one level.
